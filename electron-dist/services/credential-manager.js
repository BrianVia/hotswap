 ...
 */
export async function checkAuthStatus(profileName) {
    try {
        ...
        console.log(`Auth check failed for ${profileName}:`, error.message);
        return {
            authenticated: false,
            profileName,
        };
 ...
 */
export function getCredentialProvider(profileName) {
 ...
 */
export function clearCredentialProvider(profileName) {
